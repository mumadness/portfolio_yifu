...
export default function HomeMain() {
    ...
    const homeImages = [
        {
            img: montanaSun,
            description: "This picture was taken in beautiful Bozeman, Montana. \
                          I had the chance to live with my best friend there for the summer. \
                          If you like the outdoors, fresh air, and seeing animals everyday, \
                          come give Montana a look!"
        },
        {
            img: taorminaEtna,
            description: "I lived in Italy for a year. In the photo, I am in the town of Taormina in \
                          Northeastern Sicily, and in the background is Mount Etna, an active volcano"
        },
        {
            img: americanIdiot,
            description: "I was in my high school's installment of the Green Day musical 'American Idiot'. \
                          I was a supporting character that sung in the background for most songs but had a couple \
                          solos too. I was never a theater person, but this experience was incredibly fun and eye-opening"
        },
        {
            img: varsityBball,
        ...
        {
            img: cambodia,
            description: "I run a volunteering trip to Cambodia every summer. We donate and install simple solar home \
                          systems for those who cannot afford electricity"
        },
        {
            img: capitolGs,
            description: "I'm in an a cappella group called The Capitol G's at Georgetown University. \
                          We're a chill group that is not bound by any musical genre. This is us after a performance"
        }
    ]
